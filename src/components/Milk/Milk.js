...
import Form from '../Milk/MilkForm'
      ...
      <div className="sl-main-section">
        ...
        <div className="LaundryCategory row container-fluid col-12">
          ...
          <a href="#" className="laundry-card col-lg-3 col-md-6 col-sm-12">
            <div className="card MilkDaily">
                <div className="MilkDailyTitle">
                    <h3>
                    Daily
                    </h3>
                </div>
          ...
          <a href="#" className="laundry-card col-lg-3 col-md-6 col-sm-12">
              <div className="card MilkMonthly">
                  <div className="MilkMonthlyTitle">
                      <h3>
                      Monthly
                      </h3>
                  </div>
            ...
            <a href="#" className="col-lg-3 col-md-6 col-sm-12">
              <div className="card MilkHalfYearly">  
                  <div className="MilkHalfYearlyTitle">
                      <h3>
                      Half Yearly
                      </h3>
                  </div>
            ...
            <a href="#" className="col-lg-3 col-md-6 col-sm-12">
              <div className="card MilkYearly">
                  <div className="MilkYearlyTitle">
                      <h3>
                      Yearly
                      </h3>
                  </div>
